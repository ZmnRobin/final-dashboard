...
const ViewOrderDetails: React.FC<ViewOrderDetailsProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 overflow-hidden">
      <div className="container flex flex-col rounded py-2 px-3 items-center border shadow-sm bg-white w-2/6 max-h-[85%]  relative h-[calc(100vh_-_10px)] overflow-y-auto no-scrollbar">
        <XCircleIcon
